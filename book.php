...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    ...
    echo 'Congratulation!!! Enjoy your vacation';
}
...
if(isset($_POST['send'])){
   ...
   if (empty($name) || empty($email) || empty($phone) || empty($address) || empty($location) || empty($guests) || empty($arrivals) || empty($leaving)) {
      $fail_msg[] = 'All informations are required.'; 
  }
  else{
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>contact info</h3>
         <a href="#"> <i class="fas fa-phone"></i> +188 45 321 </a>
         <a href="#"> <i class="fas fa-phone"></i> +111-222-3333 </a>
         <a href="#"> <i class="fas fa-envelope"></i> taiyebah@gmail.com </a>
         <a href="#"> <i class="fas fa-map"></i> rajshahi, bd - 400104 </a>
      </div>
   ...
   <div class="credit"> created by <span>Taiyebah Tazkiyah</span> | all rights reserved! </div>
...
if(isset($fail_msg)){
   foreach($fail_msg as $fail_msg){
      echo '<script>swal("'.$fail_msg.'", "", "fail");</script>';
   }
}
?>
